...
- Owns **all** cable Ethernet: picks one with carrier (`interface` null / omitted / `"auto"`, wait ≤5 s); remaining ifaces are flushed and admin-down. Unplug → re-pick after ~10 s. An explicit name pins the device
